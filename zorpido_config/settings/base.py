...
# Email configuration - use console backend by default (safe for development)
...
if os.environ.get('EMAIL_HOST'):
    ...
    DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@zorpido.com')

# AUTH_USER_MODEL must be declared after all models are loaded
